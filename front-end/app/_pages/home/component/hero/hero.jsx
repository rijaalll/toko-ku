    ...
    return (
        <section className='w-full h-[100dvh]'>
            <div className='w-full h-full flex justify-center items-center'>
                <div className='w-[90%] h-[90%] max-md:max-w-[28rem] md:w-[95%] flex flex-col max-md:items-center md:flex-row md:bg-zinc-300/60 md:rounded-2xl md:h-[60dvh] gap-12'>

                    <div className='w-full h-[60%] flex justify-start items-end md:basis-1/2 md:order-1 md:self-end'>
                        <div className='w-full h-[50%] md:h-full max-md:bg-zinc-300/60 rounded-2xl relative'>
                            <div className='w-full h-auto'>
                                <div className='absolute bottom-0 w-[70%] max-w-[15rem] md:w-full md:max-w-[20rem]'>
                                    <MainComment text={"1k+ Ratings"} top={30} right={0} star={4} fontSize={12} />
                    ...
                    <div className='w-full h-[40%] md:basis-1/2 md:h-full md:px-8'>
                        <div className='w-full h-full flex justify-start items-start md:items-center'>
                            <div className='w-auto h-auto flex flex-col gap-2'>
                                <p className='text-3xl md:text-4xl'>Temukan passion anda</p>
                                <p className='text-xl'>Di Panjul Shop</p>  
